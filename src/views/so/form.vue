  ...
  <div class="container">
    <div class="header van-hairline--bottom">
      <van-form>
        ...
        <van-field class="item" v-model="headForm.cRdName" readonly name="cRdName" label="出库方式" placeholder="请选择出库方式"
        ...
        <div class="list0" id="list0">
          <div ref="postForm" class="postForm inputForm">
            ...
            <van-field type="text" name="cBarcode" label="条码" ref="ele_cBarcode" v-model="form.cBarcode"
              autocomplete="off" placeholder="扫描或录入条码" id="ele_cBarcode" @keyup.enter="queryInv"></van-field>
            ...
            <van-field name="iPlanQuantity" label="发货数量" ref="ele_iPlanQuantity" v-model="form.iPlanQuantity"
              placeholder="发货数量" readonly></van-field>
            ...
            <van-field name="iStockQuantity" label="库存数量" ref="ele_iStockQuantity" v-model="form.iStockQuantity"
              placeholder="库存数量" readonly></van-field>
